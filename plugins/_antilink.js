...
export async function before(m, { conn, isAdmin, isBotAdmin, usedPrefix }) {
    ...
    if (chat.antiLink && isGroupLink && !isAdmin) {
        if (isBotAdmin) {
            ...
            if (m.text.includes(linkThisGroup)) return m.reply('[ ! ] Uy acabas de enviar un enlace, lo weno es que el enlace detectado es de este grupo te salvaste está vez')
        }
